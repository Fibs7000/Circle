...
type StylesProp = {
    ...
    separator?: ViewStyle,
    loader?: ViewStyle,
    specialItemRow?: ViewStyle
}

const defaultStyles: StylesProp & any = {
    container: {
        flex: 1,
    },
    textInputContainer: {
...
type props = {
    ...
    onPress?: (data: PlaceType & {[key: string]: any}, details?: any)=>void,
    onNotFound?: (responseJSON: string)=>void,
    ...
    predefinedPlaces?: {description: string}[],
    ...
    renderDescription?: (rowData: any)=>JSX.Element,
    ...
    renderHeaderComponent?: (text: string) => JSX.Element,
...
export default class GooglePlacesAutocomplete extends Component<props, { text: string, dataSource: any[], listViewDisplayed: boolean }> {
    _isMounted = false;
    _results = [];
    _requests = [];
    ...
    refs: {textInput: TextInput | null} = {textInput: null}
    constructor(props) {
        super(props);
    ...
    _renderRow = (rowData: any = {}, sectionID?, rowID?) => {
        return (
            <ScrollView
                style={{ flex: 1 }}
